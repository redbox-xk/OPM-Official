                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-wrap items-center gap-3 justify-center md:justify-start text-xs text-muted-foreground">
                    <a href={`mailto:${FOUNDER_EMAIL}`} className="flex items-center gap-1 hover:text-[#D4A537] transition-colors">
                      <Mail className="w-3 h-3" /> {FOUNDER_EMAIL}
                    </a>
                    <span className="flex items-center gap-1">
                      <Globe className="w-3 h-3" /> {COMPANY_LOCATION}
                    </span>
                  </div>
                  <div className="mt-2 text-xs text-muted-foreground flex items-center gap-1 justify-center md:justify-start">
                    <Building2 className="w-3 h-3" /> {COMPANY_ADDRESS}
                  </div>
                </div>
              </div>
            </div>

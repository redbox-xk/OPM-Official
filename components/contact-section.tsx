...
import { Mail, Twitter, Send, Globe, ExternalLink, MapPin, Building2 } from "lucide-react"
import { CONTACT_EMAIL, FOUNDER_EMAIL, TWITTER_URL, TELEGRAM_URL, WEBSITE_URL, COMPANY_ADDRESS, FOUNDER_NAME } from "@/lib/constants"
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="text-center space-y-2 py-2">
                ...
                <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
                  ...
                  <a href={`mailto:${FOUNDER_EMAIL}`} className="hover:text-[#D4A537] transition-colors">{FOUNDER_EMAIL}</a>
                </div>
              </div>

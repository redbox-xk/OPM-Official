...
// SECURITY: All API keys moved to server-side environment variables
// Never expose API keys in frontend code

// Contact
export const CONTACT_EMAIL = "kontakt@onepremium.de"
export const FOUNDER_EMAIL = "bardh.idrizi@onepremium.de"
export const FOUNDER_NAME = "Bardh Idrizi"
export const COMPANY_ADDRESS = "Hauptstrasse 3 (2. Stock), 10827 Berlin, Deutschland"
export const COMPANY_LOCATION = "Berlin, Germany"
...
// Banxa Fiat On-Ramp
export const BANXA_CHECKOUT_URL = "https://checkout.banxa.com"

// Supported Chains
export const SUPPORTED_CHAINS = {
  ETHEREUM: { id: 1, name: "Ethereum", rpc: "ethereum", symbol: "ETH", explorer: "https://etherscan.io" },
  BSC: { id: 56, name: "BNB Smart Chain", rpc: "bsc", symbol: "BNB", explorer: "https://bscscan.com" },
  POLYGON: { id: 137, name: "Polygon", rpc: "polygon", symbol: "MATIC", explorer: "https://polygonscan.com" },
  ARBITRUM: { id: 42161, name: "Arbitrum", rpc: "arbitrum", symbol: "ETH", explorer: "https://arbiscan.io" },
  OPTIMISM: { id: 10, name: "Optimism", rpc: "optimism", symbol: "ETH", explorer: "https://optimistic.etherscan.io" },
} as const
...
// Creator/Founder wallet address - exempt from lock period
export const CREATOR_WALLET_ADDRESS = "0xE430b07F7B168E77B07b29482DbF89EafA53f484" // Founder wallet
